    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <ul class="menu">
                ...
                <li><a href="report_found.php" style="background:#214a7c;">Report Found Item</a></li>
        ...
        <div class="main">
            <div class="form-box">
                ...
                <form action="php/save_found.php" method="POST" enctype="multipart/form-data">

                    <div class="form-group">
                        <label>Item Name</label>
                        <input type="text" name="item_name" placeholder="E.g. Student ID Card, Silver Watch" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="location" placeholder="E.g. Near Basketball Court, Room 402" required>
                    </div>
